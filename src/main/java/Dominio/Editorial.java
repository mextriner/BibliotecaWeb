...
public class Editorial implements Serializable {
    ...
    @JoinTable(name = "libro_has_editorial", joinColumns = {
        @JoinColumn(name = "Editorial_idEditorial", referencedColumnName = "idEditorial")}, inverseJoinColumns = {
    ...
    public String toString() {
        return "Dominio.Editorial[ idEditorial=" + idEditorial + " ]";
    }
