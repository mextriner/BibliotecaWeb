            ...
            <div class="row d-flex justify-content-center">
                <div class="col-sm-12 col-md-4 mt-3 mb-3 text-light">
                    <form method="POST" action="Usuario?accion=insertar">
                        <h1 style="font-size: 30px; ;"><strong>REGISTRO </strong><i class="fa-solid fa-user"></i></h1>¿YA TIENES CUENTA? <a class="text-light" href="inicioSesion.jsp">INICIA SESIÓN</a><br>
